        ...
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
          ...
          <div className="flex md:order-2">
            ...
            <div className="relative hidden md:block">
              <div className="absolute inset-y-0 flex items-center pointer-events-none bottom-2 start-0 ps-3">
                <svg
            ...
            <div className="flex items-start ml-5">
              ...
              <Link
                type="button"
                className="px-5 py-2 text-sm font-medium border-2 border-purple-500 border-solid rounded-lg"
                to="/login"
              >
                Login
              </Link>
            ...
            <ul className="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li className="w-[200px] relative">
                ...
                <div
                  className={`${
                    dropdown
                      ? "bg-gray-300 w-[140px] absolute top-[32px] rounded-md right-[40%] leading-8 z-10"
                      : "hidden"
                  }`}
                >
                  <li className="px-3 py-2 rounded-md hover:bg-gray-200">
                    <a href="">Item 1</a>
                  </li>
                  <li className="px-3 py-2 rounded-md hover:bg-gray-200">
                    <a href="">Item 1</a>
