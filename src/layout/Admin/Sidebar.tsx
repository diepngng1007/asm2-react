    ...
    <div className='flex'>
        ...
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            ...
            <li>
                ...
                <ul id="dropdown-example" style={{transition:"1s",maxHeight:hidden?400:0,overflow:"hidden"}}  >
                <li>
                    <Link
            ...
            <li className='flex ml-1.5 cursor-pointer gap-1.5' >
                <ArrowLeftEndOnRectangleIcon className='text-gray-500 w-7'/>
                <button className="text-[16px]" onClick={() => LogOut()} type='button'>Log Out</button>
            </li>
            </ul>
        </div>
        </aside>
